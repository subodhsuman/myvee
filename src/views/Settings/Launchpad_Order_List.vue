    ...
    <div class="row">
      <div class="col-md-12">
        <div class="exchange_setting_heading">
          <h3 class="fw-bold">PLACED ORDER HISTORY</h3>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            ...
            <div class="tab-content" id="pills-tabContent">
              <div
                ...
                id="pills-tabContent"
                role="tabpanel"
                aria-labelledby="pills-tabContent-list-tab"
              >
                  ...
                  <table class="table">
                    ...
                    <tbody v-if="activityLog.length != 0">
                      ...
                      >
                        <!-- <td>{{item.id}}</td> -->
                        <!-- <td>{{item.name}}</td> -->
                        <td>{{ item.launch_token.symbol }}</td>
                        <td>{{ item.amount }}</td>
                        <td>{{ item.price }}</td>
                        <td>{{ item.total }}</td>
                        <td>{{ item.currency }}</td>
                        ...
                        >
                          <td class="text-capitalize" style="color: green; font-weight: 800">{{ item.status }}</td>
                        </span>
                        <span v-else>
                          <td class="text-capitalize" style="color: red; font-weight: 800">{{ item.status }}</td>
                        </span>
                      </tr>
                    </tbody>
                    <tbody v-else>
